...
_HariMain:
	...
	PUSH	EAX
	MOV	EDX,DWORD [-816+EBP]
	PUSH	DWORD [_memman]
	PUSH	DWORD [-880+EBP]
	MOV	DWORD [-928+EBP],EDX
	...
	CALL	_memman_alloc_4K
	ADD	EAX,65524
	MOV	ECX,DWORD [-944+EBP]
	MOV	EDX,DWORD [-848+EBP]
	ADD	ESP,36
	MOV	DWORD [72+ECX],EAX
	MOV	DWORD [48+ECX],_console_task
	MOV	DWORD [88+ECX],8
	MOV	DWORD [92+ECX],16
	MOV	DWORD [96+ECX],8
	MOV	DWORD [100+ECX],8
	...
	CALL	_task_run
	MOV	ECX,DWORD [-944+EBP]
	MOV	EAX,DWORD [-848+EBP]
	MOV	EDX,DWORD [-928+EBP]
	MOV	DWORD [-948+EBP],16
	OR	DWORD [32+EAX],32
	MOV	DWORD [36+EAX],ECX
	MOV	DWORD [-924+EBP],EDX
	PUSH	DWORD [-880+EBP]
	MOV	DWORD [-952+EBP],0
	CALL	_updown_mouse
L76:
...
L14:
	...
	TEST	AL,AL
	JE	L18
	MOV	ECX,DWORD [-928+EBP]
	CMP	DWORD [-924+EBP],ECX
	JE	L87
	MOVSX	EAX,AL
	ADD	EAX,256
